@if(Session::has('error'))
    <p class="alert alert-danger" style="padding: 10px; border-radius: 4px; margin-bottom: 10px;">
...
@if (session('success'))
    <div class="alert alert-success" style="padding: 10px; border-radius: 4px; margin-bottom: 10px;">
