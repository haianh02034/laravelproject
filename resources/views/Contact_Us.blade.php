...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/contact_us.css') }}">
  <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/style-starter.css') }}">
</head>
...
<script type="text/javascript" src="{{ asset('assets/js/contact-us.js') }}"></script>
<script type="text/javascript" src="{{ asset('assets/js/as-alert-message.min.js') }}"></script>
