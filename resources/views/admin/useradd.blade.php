                        ...
                        <div class="row"> 
                            <div class="col-md-12">                      
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="sign-up-name" type="text" placeholder="Name" />
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Email *</label>
                                    <input class="form-control" name="sign-up-email" type="email" placeholder="Email" />
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>  
                            <div class="col-md-12">
                            ...
                            <div class="col-md-6">                      
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="sign-up-passwd" type="password" placeholder="Password" />
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>  
                            <div class="col-md-6">                      
